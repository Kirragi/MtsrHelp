...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="usp-category">
			<label style="font-size:20px;" for="user-submitted-category">Категория заявки</label>
		...
		<fieldset class="usp-title">
			<label style="font-size:20px;" for="user-submitted-title">Тема заявки</label>
			<input id="user-submitted-title" name="user-submitted-title" type="text" value="" placeholder="Тема заявки"<?php if (usp_check_required('usp_title')) echo $usp_required; ?> class="usp-input">
		</fieldset>
		...
		<fieldset class="usp-custom">
			<label style="display:none;" for="user-submitted-custom"><?php echo esc_html($usp_custom_label); ?></label>
			<input style="display:none;" id="user-submitted-custom" name="<?php echo esc_attr($usp_custom_name); ?>" type="text" value="Ожидание" placeholder="<?php echo esc_attr($usp_custom_label); ?>"<?php if (usp_check_required('custom_field')) echo $usp_required; ?> class="usp-input">
		</fieldset>
		<?php } if ($usp_options['custom_field_2'] == 'show' || $usp_options['custom_field_2'] == 'optn') { ?>
		
		<fieldset class="usp-custom-2">
			<label style="font-size:20px;" for="user-submitted-custom-2"><?php echo esc_html($usp_custom_label_2); ?></label>
			<textarea id="user-submitted-custom-2" name="<?php echo esc_attr($usp_custom_name_2); ?>" type="text" value="" placeholder="<?php echo esc_attr($usp_custom_label_2); ?>"<?php if (usp_check_required('custom_field_2')) echo $usp_required; ?> class="usp-input" > </textarea>
		</fieldset>
		...
		<fieldset class="usp-images">
			<label style="display: none" for="user-submitted-image"><?php esc_html_e('Upload an Image', 'usp'); ?></label>
			...
			if (empty($usp_addAnother)) $usp_addAnother = '<a href="#" id="usp_add-another" class="usp-no-js plusImg a_null">+</a>';
			...
			<?php else : ?>
				...
				<input  onclick="changeButtonImg('IdImgBtn1')" name="user-submitted-image[]" type="file" size="25" class="usp-input usp-clone" data-parsley-excluded="true" accept="image/*" id="IdImgBtn1">
				<label for="IdImgBtn1" class="custom-file-upload IdImgBtn1 formImgPostBtn">Прикрепить изображение</label>
		...
		<div id="usp-submit">
			...
			<input type="submit" class="usp-submit" id="user-submitted-post" name="user-submitted-post" value="Отправить заявку">
