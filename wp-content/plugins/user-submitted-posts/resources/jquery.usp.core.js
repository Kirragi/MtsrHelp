...
jQuery(document).ready(function($) {
	...
	function usp_add_another() {
		...
		$('#usp_add-another').on('click', function(e) {
			e.preventDefault();
			x++;
			idBtnAddImg='IdImgBtn'+x;
			var link = $(this);
			var clone = $('#user-submitted-image').find('input:visible:last').clone().val('').attr('style', 'display:block;').attr('id', idBtnAddImg).attr('onclick', 'changeButtonImg("'+idBtnAddImg+'")');
			var prev = '<img class="usp-file-preview"src="" alt="" style="display:none;"><label  for="IdImgBtn'+x+'"  class="custom-file-upload formImgPostBtn '+idBtnAddImg+'">Прикрепить изображение</label>';
